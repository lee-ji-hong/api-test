...
const ApiPage = () => {
   ...
   * User API
   ************/
  const g_accessToken = import.meta.env.VITE_APP_ACCESS_TOKEN;
  const g_refreshToken = import.meta.env.VITE_APP_REFRESH_TOKEN;

  // const handleLoginRequest = async () => {
  //   try {
  //     const response = await axios.get(`${base_url}/oauth2/authorization/kakao`, {
  //       headers: {
  ...
  //   try {
  //     const response = await axios.post(`/api/v1/transfer`, data, {
  //       headers: {
  //         "Content-Type": "application/json",
  //         Accept: "application/json",
  ...
  const handleLoanAdviceRequest = async () => {
    try {
      const response = await axios.get("/api/v1/loanAdvice", {
        headers: {
          "Content-Type": "application/json",
          Accept: "application/json",
          AccessToken: g_accessToken, // 여기에 실제 액세스 토큰을 입력하세요
  ...
  const handleSpecificRequest = async () => {
    try {
      const response = await axios.get(`/api/v1/loanAdvice/specific/200`, {
        headers: {
          "Content-Type": "application/json",
          Accept: "application/json",
          AccessToken: g_accessToken, // 여기에 실제 액세스 토큰을 입력하세요
  ...
  const handleLoanAdvicePostRequest = async () => {
    ...
    try {
      const response = await axios.post("/api/v1/loanAdvice", data, {
        headers: {
          "Content-Type": "application/json",
          AccessToken: g_accessToken, // 여기에 실제 액세스 토큰을 입력하세요
          RefreshToken: g_refreshToken, // 여기에 실제 리프레시 토큰을 입력하세요
  ...
  const handleSpecificPostRequest = async () => {
    ...
    try {
      const response = await axios.post("/api/v1/loanAdvice/specific", data, {
        headers: {
          "Content-Type": "application/json",
          AccessToken: g_accessToken, // 여기에 실제 액세스 토큰을 입력하세요
          RefreshToken: g_refreshToken, // 여기에 실제 리프레시 토큰을 입력하세요
  ...
  const handleUserInputInfoRequest = async () => {
    try {
      const response = await axios.get("/api/v1/userInputInfo", {
        headers: {
          "Content-Type": "application/json",
          Accept: "application/json",
          AccessToken: g_accessToken, // 여기에 실제 액세스 토큰을 입력하세요
  ...
  const handleRecentUserInputInfoRequest = async () => {
    try {
      const response = await axios.get("/api/v1/userInputInfo/recent-ten", {
        headers: {
          "Content-Type": "application/json",
          Accept: "application/json",
          AccessToken: g_accessToken, // 여기에 실제 액세스 토큰을 입력하세요
  ...
  const handleSpecifictUserInputInfoRequest = async () => {
    try {
      const response = await axios.get("/api/v1/userInputInfo/specific/1234", {
        headers: {
          "Content-Type": "application/json",
          Accept: "application/json",
          AccessToken: g_accessToken, // 여기에 실제 액세스 토큰을 입력하세요
  ...
  const handleLtvCalcCalcRequest = async () => {
    ...
    try {
      const response = await axios.post("/api/v1/ltvCalc", data, {
        headers: {
          "Content-Type": "application/json",
          Accept: "application/json",
        },
  ...
  const handleDsrCalcRequest = async () => {
    ...
    try {
      const response = await axios.post("/api/v1/dsrCalc", data, {
        headers: {
          "Content-Type": "application/json",
          Accept: "application/json",
        },
  ...
  const handleDtiCalcRequest = async () => {
    ...
    try {
      const response = await axios.post("/api/v1/dtiCalc", data, {
        headers: {
          "Content-Type": "application/json",
          Accept: "application/json",
        },
  ...
  const handleBoardRequest = async () => {
    try {
      const response = await axios.get("/api/v1/board/posts?page=0&size=10", {
        headers: {
          "Content-Type": "application/json",
          Accept: "application/json",
          AccessToken: g_accessToken, // 여기에 실제 액세스 토큰을 입력하세요
  ...
  const handlePostsRequest = async () => {
    try {
      const response = await axios.get("/api/v1/board/posts/1", {
        headers: {
          "Content-Type": "application/json",
          Accept: "application/json",
          AccessToken: g_accessToken, // 여기에 실제 액세스 토큰을 입력하세요
  ...
  const handleWriteRequest = async () => {
    ...
    try {
      const response = await axios.post("/api/v1/board/posts", data, {
        headers: {
          "Content-Type": "application/json",
          Accept: "application/json",
          AccessToken: g_accessToken, // 여기에 실제 액세스 토큰을 입력하세요
  ...
  const handleDeleteRequest = async () => {
    try {
      const response = await axios.delete("/api/v1/board/posts/1", {
        headers: {
          "Content-Type": "application/json",
          Accept: "application/json",
          AccessToken: g_accessToken, // 여기에 실제 액세스 토큰을 입력하세요
  ...
  const handleEditRequest = async () => {
    ...
    try {
      const response = await axios.put("/api/v1/board/posts/1", data, {
        headers: {
          "Content-Type": "application/json",
          Accept: "application/json",
          AccessToken: g_accessToken, // 여기에 실제 액세스 토큰을 입력하세요
